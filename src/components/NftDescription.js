            ...
            hidden={
              !(
                ...
                (auction.isOwner &&
                  auction.isStarted &&
                  !auction.isEnded &&
                  auction.winner === ethers.constants.AddressZero)
              )
            }
          >
            <td>Interactions</td>
...
export default compose(connect(mapStateToProps, actions))(NftDescription);
